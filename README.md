...
CPU and PPU written from scratch in plain JavaScript. No emulation libraries.
...
![Tests](https://img.shields.io/badge/project_tests-13_passing-brightgreen)
...
| Suite | Result |
|---|---|
| [dmg-acid2](https://github.com/mattcurrie/dmg-acid2) (PPU) | **Pixel-perfect** — 0 / 23,040 pixel mismatches vs. real DMG hardware |
